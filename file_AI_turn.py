...
def func_AI_turn(game_status, whose_turn, counter, biases, weights, winner, store_counter_1, store_counter_2, store_choice_1, store_choice_2, training_data):
...
##        print("\n a ...\n", a)
    ...
    return (counter, whose_turn, winner, game_status, store_counter_1, store_counter_2, store_choice_1, store_choice_2, training_data)
